...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GalleryPlugin.name'
        db.add_column('cmsplugin_galleryplugin', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GalleryPlugin.name'
        db.delete_column('cmsplugin_galleryplugin', 'name')
