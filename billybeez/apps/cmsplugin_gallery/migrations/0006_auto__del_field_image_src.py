...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('cmsplugin_gallery_image', 'src')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Image.src'
        raise RuntimeError("Cannot reverse this migration. 'Image.src' and its values cannot be restored.")
