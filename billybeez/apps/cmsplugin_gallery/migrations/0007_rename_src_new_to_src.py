...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming Image.src_new to Image.src
        db.rename_column('cmsplugin_gallery_image', 'src_new_id', 'src_id')


    def backwards(self, orm):
        # Renaming Image.src to Image.src_new
        db.rename_column('cmsplugin_gallery_image', 'src_id', 'src_new_id')
