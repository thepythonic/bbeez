...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TitledPlugin.span'
        db.add_column('cmsplugin_titledplugin', 'span',
                      self.gf('django.db.models.fields.CharField')(default='Width', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TitledPlugin.span'
        db.delete_column('cmsplugin_titledplugin', 'span')
