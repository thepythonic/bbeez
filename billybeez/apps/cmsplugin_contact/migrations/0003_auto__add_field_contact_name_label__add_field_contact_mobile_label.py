...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contact.name_label'
        db.add_column('cmsplugin_contact', 'name_label',
                      self.gf('django.db.models.fields.CharField')(default='NAME', max_length=30),
                      keep_default=False)

        # Adding field 'Contact.mobile_label'
        db.add_column('cmsplugin_contact', 'mobile_label',
                      self.gf('django.db.models.fields.CharField')(default='MOBILE', max_length=14),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contact.name_label'
        db.delete_column('cmsplugin_contact', 'name_label')

        # Deleting field 'Contact.mobile_label'
        db.delete_column('cmsplugin_contact', 'mobile_label')
