...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TitledPlugin.font'
        db.add_column('cmsplugin_titledplugin', 'font',
                      self.gf('django.db.models.fields.CharField')(default='Title Font', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TitledPlugin.font'
        db.delete_column('cmsplugin_titledplugin', 'font')
