...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillybeezGame.image_plugin'
        db.add_column('cmsplugin_billybeezgame', 'image_plugin',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['cmsplugin_filer_image.FilerImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BillybeezGame.image_plugin'
        db.delete_column('cmsplugin_billybeezgame', 'image_plugin_id')
    ...
    models = {
        ...
        'cmsplugin_billybeezgames.billybeezgame': {
            ...
            'image_plugin': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['cmsplugin_filer_image.FilerImage']"}),
